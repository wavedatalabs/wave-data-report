...
$if(department)$
  \def\name{$department$}
$else$
  \def\name{Wave Data Labs\newline Suite 1, Enterprise 1\newline Innovation Campus \newline Squires Way \newline North Wollongong NSW 2500}
$endif$

$if(phone)$
  \telephone{$phone$}
$else$
  \telephone{(+61) 400 459 540}
$endif$
...
\def\webaddress{\url{https://www.wavedatalabs.com.au}}
\def\abn{45 667 197 006}
...
\includegraphics[height=0.6cm]{ssa}~~~
\includegraphics[height=0.6cm]{azure}
\end{textblock}
\begin{singlespacing}
\thispagestyle{empty}
\vspace*{-1.4cm}
...
\hbox to 16cm{
  \hbox to 6.5cm{\vbox to 14cm{\vbox to 25cm{
    \includegraphics[width=6cm]{wave-logo}
    \vfill
    % \includegraphics[width=2cm]{wave-logo}
    \vspace{0.4cm}
    \par
